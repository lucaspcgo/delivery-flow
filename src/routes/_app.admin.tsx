                ...
                <TableBody>
                  {users.map((u, i) => (
                    <TableRow key={u.id} className={i % 2 === 1 ? "bg-muted/30" : ""}>
                      ...
                      <TableCell>
                        {u.is_admin ? <Badge>Sim</Badge> : <span className="text-muted-foreground text-xs">Não</span>}
                      </TableCell>
                    </TableRow>
                  ))}
                  {users.length === 0 && (
                ...
                <TableBody>
                  {plans.map((p, i) => (
                    <TableRow key={p.id} className={i % 2 === 1 ? "bg-muted/30" : ""}>
                      ...
                      <TableCell>
                        <span
                          className={`rounded-full px-2 py-0.5 text-xs font-medium ${p.active ? "bg-green-100 text-green-700" : "bg-gray-200 text-gray-700"}`}
                        >
  ...
  return (
    <div className="space-y-6">
      <Card className="rounded-xl shadow-sm">
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground">Configurações da API e pagamento em breve...</p>
        </CardContent>
      </Card>
    </div>
  );
